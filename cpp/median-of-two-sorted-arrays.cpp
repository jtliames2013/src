...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        if ((n1+n2)%2==0) {
            double m1=findKthElement(nums1, 0, n1-1, nums2, 0, n2-1, m-1);
            double m2=findKthElement(nums1, 0, n1-1, nums2, 0, n2-1, m);
            return (m1+m2)/2.0;
        } else {
            return findKthElement(nums1, 0, n1-1, nums2, 0, n2-1, m);
        }
    }
private:
